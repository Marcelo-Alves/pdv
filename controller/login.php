...
class Login{
	public static function lista(){
		...
		$campos = 'f.id_funcionario,f.nome as nome,  f.email, f.usuario,n.painel,n.nivel,n.cliente,n.categoria,n.valor, n.caixa, n.venda, n.estoque, n.produto, n.ean, n.usuario, 
